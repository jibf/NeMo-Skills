...
find_users_by_name_json = {
    ...
    "parameters": {
        "type": "object",
        "properties": {"name": {"type": "string", "description": "The name to search for."}},
        "required": ["name"],
    },
    "returns": {
        "type": "array",
...
find_locations_by_name_json = {
    ...
    "parameters": {
        "type": "object",
        "properties": {"city": {"type": "string", "description": "The city name to search for."}},
        "required": ["city"],
    },
    "returns": {
        "type": "array",
...
find_foods_by_name_json = {
    ...
    "parameters": {
        "type": "object",
        "properties": {"food": {"type": "string", "description": "The food name to search for."}},
        "required": ["food"],
    },
    "returns": {
        "type": "array",
...
get_weather_at_location_json = {
    ...
    "parameters": {
        "type": "object",
        "properties": {"location_id": {"type": "integer", "description": "The location's ID."}},
